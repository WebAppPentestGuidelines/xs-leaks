...
本書はISOG-J WG1 の新技術に対する診断手法分科会によって翻訳されました。
...
本プロジェクトに関して質問や要望、改善すべき点や感想等ございましたら、本GitHubの[Issue](https://github.com/WebAppPentestGuidelines/xs-leaks/issues)にてご連絡いただけますと幸いです。
